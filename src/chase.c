...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/25 14:47:12 by yu-chen           #+#    #+#             */
/*   Updated: 2024/04/22 17:43:02 by yu-chen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_player	*ft_getnearestpac(t_game *g, t_player *ghost)
{
	...
	while (pacman)
	{
		distance = ft_euclidean_distance(ft_newvector(ghost->pos.x, \
...
int	ft_advanced_dir(t_player *gh, t_player *pac, int *distances)
{
	...
	i = 0;
	if (gh->legal.north)
		distances[i++] = ft_euclidean_distance(ft_newvector(gh->pos.x, \
	...
	if (gh->legal.south)
		...
		distances[i++] = -2;
	if (gh->legal.east)
		distances[i++] = ft_euclidean_distance(ft_newvector(gh->pos.x + 1, \
